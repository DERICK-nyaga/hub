            ...
            <div class="col-md-10">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h5 class="mb-0" id="new-employee"><i class="fas fa-user-edit me-2"></i>Edit Employee: {{ $employee->first_name }} {{ $employee->last_name }}</h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('employees.update', $employee->id) }}" method="POST" id="employeeForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('station_id') is-invalid @enderror"
                                        ...
                                        @foreach($stations as $station)
                                            <option value="{{ $station->station_id }}" {{ old('station_id', $employee->station_id) == $station->station_id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <label for="deduction_balance" class="form-label">Deductions (KES)</label>
                                    <input type="number" step="0.01" class="form-control @error('deduction_balance') is-invalid @enderror"
                                           id="deduction_balance" name="deduction_balance" value="{{ old('deduction_balance', $employee->deduction_balance) }}" required>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control @error('leave_start') is-invalid @enderror"
                                                           id="leave_start" name="leave_start" value="{{ old('leave_start', $employee->leave_start) }}">
                                                    @error('leave_start')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control @error('leave_end') is-invalid @enderror"
                                                           id="leave_end" name="leave_end" value="{{ old('leave_end', $employee->leave_end) }}">
                                                    @error('leave_end')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control @error('termination_date') is-invalid @enderror"
                                                           id="termination_date" name="termination_date" value="{{ old('termination_date', $employee->termination_date) }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control @error('last_working_day') is-invalid @enderror"
                                                           id="last_working_day" name="last_working_day" value="{{ old('last_working_day', $employee->last_working_day) }}">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="form-control @error('termination_reason') is-invalid @enderror"
                                                              id="termination_reason" name="termination_reason" rows="3">{{ old('termination_reason', $employee->termination_reason) }}</textarea>
